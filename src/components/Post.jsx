  ...
  return (
    <div className="bg-white rounded-lg shadow-xl p-6 space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold text-purple-800">{post.author}</h2>
      ...
      <div className="flex items-center space-x-4">
        ...
        <span className="text-gray-500">{Array.isArray(post.comments) ? post.comments.length : 0} Comments</span>
      </div>
      <CommentSection 
