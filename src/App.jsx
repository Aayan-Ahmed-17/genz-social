...
//     // </div>
//     <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500">
//       <Header setCurrentPage={setCurrentPage} user={user} />
//       <main className="container mx-auto px-4 py-8">
//         {/* {currentPage === 'feed' && <Feed posts={posts} setPosts={setPosts} user={user} />}
//         {currentPage === 'create' && <CreatePost addPost={setPosts} setCurrentPage={setCurrentPage} />}
//         {currentPage === 'register' && <Register setUser={setUser} setCurrentPage={setCurrentPage} />} */}
//         {currentPage === "feed" && (
//           <Feed posts={posts} setPosts={setPosts} user={user} />
//         )}
//         {currentPage === "create" && (
//           <CreatePost setPosts={setPosts} setCurrentPage={setCurrentPage} />
//         )}
